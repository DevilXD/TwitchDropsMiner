    ...
    "gui": {
        ...
        "help": {
            ...
            "how_it_works_text": (
                ...
                "It then fetches the metadata of this data stream - this is enough to advance the drops. "
                "Note that this completely bypasses the need to download any actual stream video and sound. "
                "To keep the status (ONLINE or OFFLINE) of the channels up-to-date, there's a websocket connection established "
                "that receives events about streams going up or down, or updates regarding the current number of viewers."
            ),
            ...
            "getting_started_text": (
                ...
                "4. If you want to mine specific games first, use the \"Priority\" list to set up an ordered list of games of your choice. "
                    "Games from the top of the list will be attempted to be mined first, before the ones lower down the list.\n"
                ...
                "7. Changing the contents of either of the lists or changing the state of the \"Priority only\" option, "
                    "requires you to press \"Reload\" for the changes to take effect."
            ),
        },
    },
}
